...
def test_FileDownloads(low_timeline):
    ...
    assert high_timeline.events[0].trigger.description == "Created time for file in downloads folder 2023-12-26 00:37:07.947361+00:00,Creation Time,FILE,File stat,NTFS:\\Users\\User\\Downloads\\Firefox Installer.exe Type: file,filestat,NTFS:\\Users\\User\\Downloads\\Firefox Installer.exe,-"

    # supporting events
    assert len(high_timeline.events[0].supporting) == 1
    assert high_timeline.events[0].supporting[0].id == 2
    assert high_timeline.events[0].supporting[0].description == "File Downloaded (Firefox Installer.exe) from https://cdn.stubdownloader.services.mozilla.com/builds/firefox-stub/en-US/win/ef5a2910edab879b9d22df3dbd331af666fa69b040641e1e053b2ea6ca113d26/"
    assert high_timeline.events[0].supporting[0].date_time_min == "2023-12-26 00:37:23.781311+00:00"
    assert high_timeline.events[0].supporting[0].test_event.type == "End Time-WEBHIST"
