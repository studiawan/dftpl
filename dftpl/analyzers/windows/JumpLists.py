...
# TODO: Update parser for .automaticDestinations-ms when references on how to interpret the data is found
...
def FindRunRunOnceRegistry(low_timeline, start_id, end_id):
    ...
    for each_low_event in trigger_matches:
        ...
        high_event.description = f"Update time for '{reg_path}' registry key with {entries_len} entries"
